...
export const NOTIFICATION_TYPES = {
  ...
  RESIGNATION_EFFECTIVE: 'resignation_effective',
...
export const NOTIFICATION_TYPE_LABELS = {
  ...
  [NOTIFICATION_TYPES.RESIGNATION_EFFECTIVE]: '离职生效通知',
  [NOTIFICATION_TYPES.RESIGNATION_PENDING]: '离职待确认'
}
...
export const NOTIFICATION_TYPE_ICONS = {
  ...
  [NOTIFICATION_TYPES.RESIGNATION_EFFECTIVE]: '🚪',
  [NOTIFICATION_TYPES.RESIGNATION_PENDING]: '📋'
}
...
export const NOTIFICATION_TYPE_COLORS = {
  ...
  [NOTIFICATION_TYPES.RESIGNATION_EFFECTIVE]: '#cf1322',
  [NOTIFICATION_TYPES.RESIGNATION_PENDING]: '#d4380d'
}
...
export const NOTIFICATION_CATEGORY_LABELS = {
  ...
  [NOTIFICATION_CATEGORIES.HR]: '人事通知'
}
...
const TYPE_TO_CATEGORY = {
  ...
  [NOTIFICATION_TYPES.RESIGNATION_EFFECTIVE]: NOTIFICATION_CATEGORIES.HR,
  [NOTIFICATION_TYPES.RESIGNATION_PENDING]: NOTIFICATION_CATEGORIES.HR
}
