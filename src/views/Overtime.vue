      ...
      <div v-else class="requests-list">
        ...
        >
          ...
          <div class="request-footer">
            ...
            <div class="request-actions" v-if="canApprove(request)">
...
const filteredRequests = computed(() => {
  ...
  if (activeTab.value === 'pending') {
    return myRequests.value.filter(r => !isOvertimeFinalApproved(r.status) && !isOvertimeRejected(r.status))
  }
  if (activeTab.value === 'approved') {
    return myRequests.value.filter(r => isOvertimeFinalApproved(r.status))
  }
  if (activeTab.value === 'rejected') {
    return myRequests.value.filter(r => isOvertimeRejected(r.status))
  }
